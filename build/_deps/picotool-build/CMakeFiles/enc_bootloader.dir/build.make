...
CMakeFiles/enc_bootloader-complete: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-install
	...
	/usr/local/bin/cmake -E touch /root/pico/pomodoro-timer/build/_deps/picotool-build/CMakeFiles/enc_bootloader-complete
	/usr/local/bin/cmake -E touch /root/pico/pomodoro-timer/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-done
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-build: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-configure
	cd /root/pico/pomodoro-timer/build/_deps/picotool-build/enc_bootloader && $(MAKE)
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-configure: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-patch
	cd /root/pico/pomodoro-timer/build/_deps/picotool-build/enc_bootloader && /usr/local/bin/cmake -DCMAKE_MAKE_PROGRAM:FILEPATH=/usr/bin/gmake -DPICO_SDK_PATH:FILEPATH=/root/pico/pico-sdk -DUSE_PRECOMPILED:BOOL=true -DUSE_MBEDTLS=0 -DPICO_DEBUG_INFO_IN_RELEASE=OFF "-GUnix Makefiles" -S /root/pico/pomodoro-timer/build/_deps/picotool-src/enc_bootloader -B /root/pico/pomodoro-timer/build/_deps/picotool-build/enc_bootloader
	cd /root/pico/pomodoro-timer/build/_deps/picotool-build/enc_bootloader && /usr/local/bin/cmake -E touch /root/pico/pomodoro-timer/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-configure
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-download: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-mkdir
	...
	/usr/local/bin/cmake -E touch /root/pico/pomodoro-timer/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-download
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-install: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-build
	cd /root/pico/pomodoro-timer/build/_deps/picotool-build/enc_bootloader && /usr/local/bin/cmake -E echo_append

enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-mkdir:
	/usr/local/bin/cmake -Dcfgdir= -P /root/pico/pomodoro-timer/build/_deps/picotool-build/enc_bootloader/tmp/enc_bootloader-mkdirs.cmake
	/usr/local/bin/cmake -E touch /root/pico/pomodoro-timer/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-mkdir
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-patch: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-update
	/usr/local/bin/cmake -E echo_append
	/usr/local/bin/cmake -E touch /root/pico/pomodoro-timer/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-patch
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-update: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-download
	/usr/local/bin/cmake -E echo_append
	/usr/local/bin/cmake -E touch /root/pico/pomodoro-timer/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-update
